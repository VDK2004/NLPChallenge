...
AVAILABLE_MODELS = {
    "Claude 3 Opus": LLMConfig(
        ...
        description="Most powerful model with massive context window. Best for complex analysis and large documents.",
        temperature=0.7,
        max_tokens=4096
    ),
    "Claude 3 Sonnet": LLMConfig(
        ...
        description="Balanced performance model with large context window. Good for most tasks.",
        temperature=0.7,
        max_tokens=4096
    ),
    "GPT-4": LLMConfig(
